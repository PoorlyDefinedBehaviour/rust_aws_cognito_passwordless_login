...
resource "aws_iam_role_policy" "cognito_define_auth_challenge_role_policy" {
  name   = "cognito_define_auth_challenge_role_policy"
  role   = aws_iam_role.cognito_define_auth_challenge_role.name
  policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
